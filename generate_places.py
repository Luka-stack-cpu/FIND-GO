...
js_content = "const BISHKEK_PLACES = " + json.dumps(places, indent=4, ensure_ascii=False) + ";\n\nif (typeof module !== 'undefined' && module.exports) {\n    module.exports = { BISHKEK_PLACES };\n}\n"

with open("public/places-data.js", "w", encoding="utf-8") as f:
    f.write(js_content)

print("Created places-data.js")
